...
function Content(props: any) {
  ...
  function findLocationById(locations: any[], id: string): any | undefined {
              ...
              { wasSent && <>
                <Alert variant="soft-primary" className="flex items-center mt-12">
                  ...
                  <svg width="320" height="315" viewBox="0 0 320 315" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0 0L102.069 225.243L168.132 181.85L212.607 192.746L221.908 125.397L268.87 78.3034L0 0ZM44.7093 35.3053L201.638 119.079L199.605 166.508L44.7093 35.3053Z" fill="#6489db"/>
                    <path d="M229.209 209.328C236.99 217.036 244.214 225.182 251.264 233.46C258.284 241.752 265.099 250.206 271.71 258.82C278.32 267.419 284.741 276.18 290.942 285.116C297.114 294.067 303.125 303.134 308.551 312.655C300.755 304.948 293.545 296.816 286.496 288.538C279.476 280.246 272.661 271.792 266.05 263.178C259.439 254.564 253.019 245.803 246.832 236.882C240.646 227.902 234.65 218.835 229.209 209.328Z" fill="#243C70"/>
                    <path d="M161.961 210.793C169.742 218.5 176.966 226.647 184.016 234.925C191.036 243.217 197.851 251.67 204.462 260.285C211.072 268.884 217.493 277.645 223.694 286.581C229.866 295.531 235.877 304.599 241.303 314.12C233.507 306.413 226.297 298.281 219.248 290.003C212.228 281.711 205.412 273.257 198.802 264.643C192.191 256.029 185.771 247.268 179.57 238.347C173.413 229.367 167.402 220.299 161.961 210.793Z" fill="#243C70"/>
