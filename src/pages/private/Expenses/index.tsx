            ...
            return (
              <>
               { showGroupById &&
                ...
                <div  key={`${i}-CARD-LOCATIONS`} className="col-span-4 md:col-span-2 xl:col-span-1 p-5 border border-dashed rounded-[0.6rem] border-slate-300/80 box shadow-sm">
                  <div className="text-base text-slate-500 uppercase">
                    <h3>{item?.name}</h3>
                    <p className="text-[.6rem]"> <span className=" font-thin">{item?.city}</span></p>
                    {/* {item?.group} */}
                    </div>
                  <div className="flex flex-row items-center justify-between ">
                    <div className="mt-1.5 text-2xl font-medium border border-success/10 bg-green-300/10 px-6 py-2 rounded-lg">
                      <p className="text-sm font-thin text-center">Ingresos</p>
                      <p className="text-xl font-medium text-center p-2">$ 0</p>
                    </div>
                    <div className="mt-1.5 text-2xl font-medium border border-red-300/10 bg-red-300/10 px-6 py-2 rounded-lg">
                      <p className="text-sm font-thin text-center">Gastos</p>
                      <p className="text-xl font-medium text-center p-2">$ 0</p>
                    </div>
                  </div>  
                    ...
                    <Popover.Panel placement="bottom-end">
                      <div className="p-2">
                        ...
                        <div className="flex items-center mt-4">
                          ...
                          <Button variant="primary" className="w-56 ml-2">
                            Aplicar
                          </Button>
                        </div>
                      </div>
...
function Main() {
  ...
  useEffect(() => { 
    ...
    (async () =>  await dispatch(getSessionByLocationAndDate({
      // sessionDate: String("2025-09-"), 
      locationId: "CLUB-PATO-CORNEJO"
    }))
  )()
  }, []);
  return (
