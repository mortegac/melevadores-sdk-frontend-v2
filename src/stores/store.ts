...
import customerMessagesReducer from './CustomerMessages/slice';
import customerActionsReducer from './CustomerActions/slice';
...
export const store = configureStore({
  reducer: {
    ...
    customerActions: customerActionsReducer,
