  ...
  return(
    ...
    {/* <pre>{JSON.stringify(props, null, 2)}</pre> */}
      <div className="flex flex-row border-1 ">
        <div className="flex flex-col items-center justify-center border-r-4 px-2">
          ...
          <h2 className="text-base text-center font-medium uppercase text-slate-600  px-4 py-2 w-full mt-4">
...
function Sessions(props: any) {
  ...
  // const sortedArray = sortByTotalSessions(Sessions);
  
  const sortedSessionTypes = useMemo(() => {
    return [...Sessions].sort((a, b) => 
      a.sessionType.totalSessions - b.sessionType.totalSessions
    );
  }, [Sessions]);
