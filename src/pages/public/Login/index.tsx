    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="text-center mt-8">
        <Button
          rounded
          type="submit"
          className="mb-4 w-full bg-gradient-to-r from-[#6489db] to-[#243C70] px-12 py-4 border-[1px] border-[#6489db]"
        >
                  ...
                  <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="text-center intro-x xl:mt-8 xl:text-left">
                      <Button
                        rounded
                        type="submit"
                        className="mb-6 w-full bg-gradient-to-r from-[#6489db] to-[#243C70] px-12 py-4 border-[1px] border-[#6489db] "
                      >
